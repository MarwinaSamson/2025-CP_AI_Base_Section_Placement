"""
Standalone test to verify Hybrid recommender works independently
"""
import sys
import pandas as pd
import numpy as np
...
print("=" * 80)
print("TESTING HYBRID RECOMMENDER (STANDALONE)")
print("=" * 80)

# Test 1: Load Hybrid recommender
print("\n[1/2] Testing Hybrid recommender load...")
try:
...
# Test 2: Create test student data
print("\n[2/2] Testing prediction with sample data...")
...
print("TEST PASSED ✓")
print("=" * 80)
print("\nHybrid recommender is working correctly!")
print("Integration with Django signals is ready for testing.")
