...
def transferee_documents(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            _save_transferee_documents(student, document_submissions)
            ...
            messages.success(request, 'Documents submitted successfully! Your enrollment is complete.')
...
def _save_transferee_documents(student, document_submissions):
